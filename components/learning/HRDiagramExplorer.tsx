...
<svg viewBox="0 0 420 260" className="w-full h-64 rounded-xl border border-white/20 p-2 bg-slate-950/70"><defs><linearGradient id="temp" x1="0" x2="1"><stop offset="0" stopColor="#60a5fa"/><stop offset="1" stopColor="#f87171"/></linearGradient></defs><rect x="20" y="20" width="380" height="210" fill="none" stroke="#94a3b8"/><text x="30" y="248" fontSize="11">고온(왼쪽)</text><text x="320" y="248" fontSize="11">저온(오른쪽)</text><text x="2" y="40" fontSize="11">광도↑</text><line x1="50" y1="60" x2="350" y2="190" stroke="url(#temp)" strokeWidth="18" opacity="0.8"/><circle cx="335" cy="95" r="24" fill="#f59e0b88"/><circle cx="300" cy="60" r="28" fill="#fb718588"/><circle cx="90" cy="200" r="18" fill="#bfdbfe99"/><circle cx="200" cy="35" r="30" fill="#c084fc77"/></svg>
